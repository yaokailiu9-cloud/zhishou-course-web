...
function(scope){with(scope){try{return (birthday || '请选择')}catch(_){return undefined}}},
...
function(scope){with(scope){try{return (savedDeadlineText)}catch(_){return undefined}}},
...
function(scope){with(scope){try{return (allowed ? '刷新签到信息' : '重新核实权限')}catch(_){return undefined}}},
...
function(scope){with(scope){try{return (entryCode)}catch(_){return undefined}}},
...
function(scope){with(scope){try{return (candidate.phone)}catch(_){return undefined}}},
...
function(scope){with(scope){try{return (classId ? '搜索报名人姓名或手机号' : '搜索课程名称')}catch(_){return undefined}}},
...
function(scope){with(scope){try{return (loading && !allowed)}catch(_){return undefined}}},
function(scope){with(scope){try{return (!shareUrl)}catch(_){return undefined}}},
function(scope){with(scope){try{return (allowed && isManager)}catch(_){return undefined}}},
function(scope){with(scope){try{return (recordsLoading ? '…' : pendingCount)}catch(_){return undefined}}},
function(scope){with(scope){try{return (activeTab === item.key ? 'active' : '')}catch(_){return undefined}}},
function(scope){with(scope){try{return (counts[item.key])}catch(_){return undefined}}},
function(scope){with(scope){try{return (filtered)}catch(_){return undefined}}},
function(scope){with(scope){try{return (item.child_name || '未填写姓名')}catch(_){return undefined}}},
function(scope){with(scope){try{return (item.guardian_name || '未填写')}catch(_){return undefined}}},
function(scope){with(scope){try{return (item.status)}catch(_){return undefined}}},
function(scope){with(scope){try{return (item.submittedText)}catch(_){return undefined}}},
function(scope){with(scope){try{return (item.status === 'CONFIRMED' ? '查看回复' : '处理工单')}catch(_){return undefined}}},
function(scope){with(scope){try{return (!loading && !filtered.length)}catch(_){return undefined}}},
function(scope){with(scope){try{return (activeTab === 'PENDING' ? '没有待处理工单。' : activeTab === 'DRAFT' ? '没有正在处理的工单。' : activeTab === 'CONFIRMED' ? '还没有已完成工单。' : '暂时没有问卷工单。')}catch(_){return undefined}}},
function(scope){with(scope){try{return (loadingMore)}catch(_){return undefined}}},
function(scope){with(scope){try{return (loadingMore ? '正在加载…' : '加载更多工单')}catch(_){return undefined}}},
function(scope){with(scope){try{return (statusText)}catch(_){return undefined}}},
function(scope){with(scope){try{return (title)}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake)}catch(_){return undefined}}},
function(scope){with(scope){try{return (submittedText)}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.child_name || '未填写')}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.child_gender || '未填写')}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.child_age == null ? '未填写' : intake.child_age + '岁')}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.child_grade || '未填写')}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.child_economic_source || '未填写')}catch(_){return undefined}}},
function(scope){with(scope){try{return (issuesText)}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.child_description || '未填写')}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.child_daily_behavior || '未填写')}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.guardian_name || '未填写')}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.guardian_phone || '未填写')}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.canReview)}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.feedback_status === 'CONFIRMED')}catch(_){return undefined}}},
function(scope){with(scope){try{return (intake.feedback_content || '暂无回复正文')}catch(_){return undefined}}},
function(scope){with(scope){try{return (confirmedText)}catch(_){return undefined}}},
function(scope){with(scope){try{return (availableText)}catch(_){return undefined}}},
function(scope){with(scope){try{return (availableDate)}catch(_){return undefined}}},
function(scope){with(scope){try{return (minAvailableDate)}catch(_){return undefined}}},
function(scope){with(scope){try{return (maxAvailableDate)}catch(_){return undefined}}},
function(scope){with(scope){try{return (availableTime)}catch(_){return undefined}}},
function(scope){with(scope){try{return (offer && offer.inviterName ? '由 ' + offer.inviterName + ' 邀请填写' : '围绕家庭当前最需要解决的问题，完成一次结构化梳理')}catch(_){return undefined}}},
function(scope){with(scope){try{return (!offer)}catch(_){return undefined}}},
function(scope){with(scope){try{return (offer && !paid)}catch(_){return undefined}}},
function(scope){with(scope){try{return (priceText)}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.guardianName)}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.guardianPhone)}catch(_){return undefined}}},
function(scope){with(scope){try{return (busy ? '正在确认支付…' : loggedIn ? '支付 ¥' + priceText + '，开始填写' : '微信登录并支付 ¥' + priceText)}catch(_){return undefined}}},
function(scope){with(scope){try{return (offer && paid)}catch(_){return undefined}}},
function(scope){with(scope){try{return (submitted)}catch(_){return undefined}}},
function(scope){with(scope){try{return (feedbackState)}catch(_){return undefined}}},
function(scope){with(scope){try{return (feedbackTitle)}catch(_){return undefined}}},
function(scope){with(scope){try{return (feedbackState === 'READY' ? '可查看' : feedbackState === 'WAITING' ? '待开放' : feedbackState === 'DRAFT' ? '处理中' : '待处理')}catch(_){return undefined}}},
function(scope){with(scope){try{return (feedbackNote)}catch(_){return undefined}}},
function(scope){with(scope){try{return (feedbackState === 'WAITING')}catch(_){return undefined}}},
function(scope){with(scope){try{return (feedbackAvailableText)}catch(_){return undefined}}},
function(scope){with(scope){try{return (feedbackState === 'READY')}catch(_){return undefined}}},
function(scope){with(scope){try{return (feedbackState !== 'READY')}catch(_){return undefined}}},
function(scope){with(scope){try{return (loading ? '正在刷新…' : '刷新处理进度')}catch(_){return undefined}}},
function(scope){with(scope){try{return (['男','女','不便透露'])}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.gender === item ? 'selected' : '')}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.age)}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.grade)}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.economicSource)}catch(_){return undefined}}},
function(scope){with(scope){try{return (issues)}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.issues.indexOf(item) >= 0 ? 'selected' : '')}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.issues.indexOf(item) >= 0)}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.dailyBehavior)}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.consent ? 'checked' : '')}catch(_){return undefined}}},
function(scope){with(scope){try{return (form.consent ? '✓' : '')}catch(_){return undefined}}},
function(scope){with(scope){try{return (busy ? '正在提交…' : '提交问卷')}catch(_){return undefined}}},
...
const ALLOWED = new Set(['customer','public-class','public-class-detail','class-enroll','my-enrollments','class-ticket','course-manage','course-edit','course-roster','service-workbench','consultation-detail','advisor','profile-edit','questionnaire-share','questionnaire-work-orders','questionnaire-review','questionnaire','chat']);
...
"utils/questionnaire":function(require,module,exports,Page,wx,getApp,getCurrentPages){
const service=require('./consultationService');
...
function poster(canvas,{url,title='知守课程报名',name='',label='知守 · 课程邀请',tip='微信扫一扫 / 长按识别二维码',afterTip}) {
 ...
 ctx.fillStyle='#123b35';ctx.font='bold 32px sans-serif';ctx.fillText(label,60,78);
 ...
 ctx.textAlign='center';ctx.font='bold 30px sans-serif';ctx.fillText(tip,375,865);
 ctx.font='25px sans-serif';ctx.fillText(afterTip||(/[?&]ref=/.test(url)?'登录后进入课程，推荐信息自动保留':'请在微信内打开'),375,914);
  ...
  data: {
    ...
    dataGroups: [
      ...
      },
      {
        title: "可选的定位辅助",
        tag: "可选",
        items: ["你主动点击定位按钮后获取的经纬度", "经反向地理编码得到的城市和地区名称"],
        purpose: "只用于辅助填写个人资料中的所在地区和详细地址；你可以拒绝定位并手动填写。"
      },
      {
        title: "预约与订单",
        items: [
          "咨询师、预约时间、服务时长",
          "订单号、金额、支付状态",
          "简易方案梳理问卷中的孩子基本情况、问题选项、问题描述、日常表现及监护人联系方式",
          "问题分类、问题摘要、服务来源"
        ],
        purpose: "用于创建简易方案梳理或一对一文字咨询订单、安排服务、处理支付与售后。"
      },
      {
        title: "咨询会话",
        items: [
    ...
    sections: [
      ...
      },
      {
        title: "二、我们如何使用信息",
        paragraphs: [
          "我们使用账号信息完成登录识别、手机号绑定和个人中心展示；使用预约和订单信息完成服务购买、支付确认、会话开通和售后处理；使用问卷信息完成简易方案梳理；使用聊天信息完成一对一文字问答、经理接单、消息保存和服务复盘。",
      ...
      },
      {
        title: "三、委托处理与第三方",
        paragraphs: [
          "为实现小程序能力，我们会使用微信提供的登录、手机号授权和支付能力；为实现后端数据存储、GraphQL 接口、会话和订单管理，我们会使用 Zion/Functorz 后端服务。你在网页端主动使用定位辅助时，浏览器获取的经纬度会发送给 BigDataCloud 的免密钥反向地理编码接口，用于换取城市和地区名称。",
...
"pages/questionnaire-share/questionnaire-share":function(require,module,exports,Page,wx,getApp,getCurrentPages){
const auth=require('../../utils/auth');
const referral=require('../../utils/referral');
const service=require('../../utils/consultationService');
const qr=require('../../utils/courseQr');
...
"pages/questionnaire-work-orders/questionnaire-work-orders":function(require,module,exports,Page,wx,getApp,getCurrentPages){
const auth=require('../../utils/auth');
const service=require('../../utils/consultationService');
const QUESTIONNAIRE_CLASS_ID='11';
const tabs=[
...
"pages/questionnaire-review/questionnaire-review":function(require,module,exports,Page,wx,getApp,getCurrentPages){
const auth=require('../../utils/auth');
const service=require('../../utils/consultationService');
...
"pages/questionnaire/questionnaire":function(require,module,exports,Page,wx,getApp,getCurrentPages){
const auth=require('../../utils/auth');
