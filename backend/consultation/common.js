...
function isNull(column, type) { var x = {}; x[(type || "bigint") + "_operand"] = {column: column}; return {_is_null: x}; }
// Rows written before 业务类型 existed, or added directly in the Zion console, must stay visible as courses.
var COURSE_SCOPE = {_or: [eq("product_kind", "COURSE", "text"), isNull("product_kind", "text")]};
function isQuestionnaire(c) { return !!c && c.product_kind === "QUESTIONNAIRE"; }
